  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-md px-4 pt-20 pb-24">
        ...
        <h1 className="mb-8 text-center text-3xl font-bold text-gray-900">Welcome back</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="mb-1.5 block text-sm font-bold text-gray-900">Password</label>
            <input
              type="password"
              required
              value={password}
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link to="/signup" className="font-medium text-gray-900 underline underline-offset-4 hover:text-gray-600">
            Sign up
          </Link>
        </p>
